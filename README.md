...
- **para as Barras de Progresso (RAM/Disco):** O programa usa fontes Unicode padrão. Para melhor visualização dos ícones, recomendamos o uso de uma **Nerd Font** no seu terminal (como a JetBrainsMono Nerd Font).
